...
namespace StudyApp.viewModels
{
    ...
    class InsertModule
    {
        ...
        {
            subject.addEnglishSubject("Which bird can also fly backwards?", "Hummingbird", "Eagle", "Butterfly", "GRADE 6", "no");
            ...
            subject.addEnglishSubject("What is a rough diamond", "A person without much education", "Person with social manners", "An educated person", "GRADE 11", "no");
